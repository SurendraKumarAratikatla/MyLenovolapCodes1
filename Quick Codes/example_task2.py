...
df_country_column = df['CountryName'][8:230]
...
df1 = df[['TotalCases', 'ActiveCases', 'TotalDeaths', 'RecoveryRate', 'PercentageOfPopulationInfected']][8:230]

df1.fillna(0,inplace=True)
for country in df_country_column:
    temp_dict = {}
    # temp_dict['Country Name'] = country
    temp_dict['Total Cases'] = df1.loc[country].TotalCases
    temp_dict['Active Cases'] = df1.loc[country].ActiveCases
    temp_dict['Total Deaths'] = df1.loc[country].TotalDeaths
...
result_dict["Coronavirus cases summary"] = country_dict
